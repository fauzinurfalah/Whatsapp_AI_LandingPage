  ...
  return (
    <footer className="bg-white text-gray-700">
      ...
      <div className="bg-blue-800 text-white">
        <div className="container mx-auto max-w-7xl px-4 py-4 flex flex-col md:flex-row md:justify-between items-center gap-4 md:gap-8">
          <p className="text-sm text-center order-2 md:order-1">
