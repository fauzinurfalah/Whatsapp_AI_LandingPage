          ...
          <div className="relative mx-auto flex max-w-7xl flex-col px-6">
            <div className="mx-auto max-w-lg lg:ml-0 lg:w-1/2">
              <h1 className="text-4xl font-bold text-gray-800 leading-tight md:text-4xl">
                Nomor <span className="text-green-500">WhatsApp </span>Sering
                KENA <span className="text-red-500">BLOKIR? </span>Hentikan
                Risiko Itu Sekarang!
              </h1>
              <p className="mt-8 max-w-xl text-lg text-gray-600 md:text-xl">
                Validasi & Panaskan nomor Anda dengan AI Training Otomatis Skala
                Besar. Dapatkan simulasi chat terukur dan pantau Keamanan Nomor
                Real-time.
              </p>
              ...
              <div className="mt-10 flex flex-row flex-wrap items-center justify-center gap-4 lg:justify-start">
                <Button
                  asChild
                  size="lg"
                  className="w-auto bg-gradient-to-r from-green-500 to-blue-600 px-8 py-6 text-lg text-white transition-transform duration-300 hover:scale-105 hover:shadow-lg"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant={"outline"}
                  className="w-auto border-2 border-blue-400 px-8 py-6 text-lg text-gray-800 transition-transform duration-300 hover:scale-105 hover:bg-blue-500 hover:text-white hover:border-blue-500 hover:shadow-lg"
                >
