...
const steps: Step[] = [
  ...
  },
  {
    ...
    description: "Sistem jalankan max 5 nomor per hari (interval acak ±60 menit).",
  },
  {
    ...
    <section id='carakerja' className="bg-gray-50 py-24 md:py-40"> 
      <div className="@container mx-auto px-4">
        <div className='text-center mb-20'>
          ...
          <h1 className='text-xl text-medium mt-5'>Tingkatkan efisiensi pengelolaan nomor WhatsApp dengan </h1>
          <h1 className='text-xl text-medium mt-5'>proses yang simpel dan terukur.</h1>
        </div>
        ...
        <div className="relative">
          <div className="flex flex-col md:flex-row justify-between space-y-12 md:space-y-0">
            {steps.map((step, index) => (
              <div key={index} className="relative z-10 flex flex-row md:flex-col items-center w-full md:w-1/5 px-4">
